...
export default function YaNeZnayuKakNazvat() {
    const [show, setShow] = useState(false)
    return (
        <div>
            <section className='w-full relative h-screen bg-center bg-cover bg-[url("/ComponentsPhotos/ComponentPhoto-2.jpg")]'>
                <div className='w-[1064px] m-auto text-center pt-32'>
                    <h1 className='text-white text-4xl font-semibold'>Дизайн в океанском стиле, который притягивает взгляд и сердце.</h1>
                </div>
            ...
            <section className={`w-[100%] overflow-hidden transition-height duration-1000 pl-10 pr-10 ${show ? 'h-[250vh]' : 'h-0'}`}>
                <div className='flex pt-[50px] mt-10'>
                    <img className='w-[50%]' src="./ComponentsPhotos/Chazor/Chazor-1.jpg" alt="" />
                ...
                <div className='flex'>
                    ...
                    <img className='w-[50%]' src="./ComponentsPhotos/Chazor/Chazor-2.jpg" alt="" />
                </div>

                {/*  */}

                <div className='flex'>
                    <img className='w-[50%]' src="./ComponentsPhotos/Chazor/Chazor-3.jpg" alt="" />
                    <div className='ml-20 m-auto w-[547px]'>
                ...
                <div className='flex'>
                    ...
                    <img className='w-[50%]' src="./ComponentsPhotos/Chazor/Chazor-4.jpg" alt="" />
                </div>

                {/*  */}

                <div className='flex'>
                    <img className='w-[50%]' src="./ComponentsPhotos/Chazor/Chazor-5.jpg" alt="" />
                    <div className='ml-20 m-auto w-[547px]'>
