...
export default function Navbar() {
  return (
    <div className="bg-gray-800 flex justify-center m-auto p-7 w-[100%]">
      <Link to='/byd-song'><img className="absolute left-7" src="https://www.byd.com/etc.clientlibs/byd-site/clientlibs/clientlib-public/resources/image/icon-logo.svg" alt="" /></Link>
