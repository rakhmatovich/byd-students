...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      {/*---section-3---*/}
      <section className='w-[100%] bg-black text-center p-16'>

        <img className='mx-auto mt-10' src="https://www.byd.com/content/dam/byd-site/uz/product/song/section1-2.jpg" alt="Быстрый" />
        <p className='text-white text-xl mt-7'>0–100 км/ч за 5,9 с (только в версии AWD)</p>
        <div className='flex mt-20'>
          <a className='decoration-white text-white hello text-3xl mx-auto' href="#">Быстрый</a>
          <a className='decoration-white text-white hello text-3xl mx-auto' href="">Эффективный</a>
          <a className='decoration-white text-white hello text-3xl mx-auto' href="">Тихий</a>
          <a className='decoration-white text-white hello text-3xl mx-auto' href="">Плавный</a>
        </div>
        <div>
      ...
      {/*---section-8---*/}
      <section className='w-[100%] mt-16 h-[1070px]'>
